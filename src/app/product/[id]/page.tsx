...
import { ProduktCarousel } from '@/components/carousel/productCarousel'
...
export default function Product() {
  ...
  return (
    <>
      <div className="col-span-12 mx-auto grid max-w-6xl grid-cols-12 lg:grid">
        <div className="col-span-12 grid md:col-span-6">
          <ProduktCarousel product={product} />
        </div>

        <div className="col-span-12 flex flex-col items-start justify-start px-6 md:col-span-7">
