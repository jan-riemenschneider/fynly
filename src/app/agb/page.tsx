    ...
    <div className="container mx-auto flex flex-col justify-start gap-6 md:gap-8">
      ...
      <div className="space-y-2 md:space-y-4">
        ...
        <p>
          ...
          Angebot dar. Der Kaufvertrag kommt zustande, wenn wir deine Bestellung
          per E-Mail bestätigen oder die Ware versenden.
        </p>
      </div>
      <div className="space-y-2 md:space-y-4">
        ...
        <p>
          ...
          Artikeln kann es zu leichten Abweichungen kommen. Diese stellen keinen
          Mangel dar. Bitte überprüfe die Angaben (z.B. Namen, Wunschtexte)
          sorgfältig vor dem Absenden der Bestellung.
        </p>
      </div>
      <div className="space-y-2 md:space-y-4">
        ...
        <p>
          ...
          (sofern ausgewiesen) zzgl. Versandkosten. Die Versandkosten werden im
          Bestellvorgang angezeigt.
        </p>
      </div>
      <div className="space-y-2 md:space-y-4">
        <h2>5. Zahlung</h2>
      ...
      <div className="space-y-2 md:space-y-4">
        <h2>9. Haftung</h2>
        <p>
          Wir haften unbeschränkt nur bei Vorsatz und grober Fahrlässigkeit. Bei
